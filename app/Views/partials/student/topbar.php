...
<header class="student-topbar">
  ...
  <button class="topbar-toggle d-none d-lg-flex" id="studentSidebarToggle" aria-label="Toggle sidebar">
  ...
  <div class="dropdown d-none d-lg-block">
    ...
    <ul class="dropdown-menu dropdown-menu-end topbar-dropdown shadow-sm">
      ...
      <li><a class="dropdown-item mt-1" href="<?= $url('learn/profile') ?>"><i class="bi bi-person me-2"></i> Profile</a></li>
