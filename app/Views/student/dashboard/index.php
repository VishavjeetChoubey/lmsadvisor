...
<div class="card lms-card mb-4" style="border-left:4px solid #6366f1">
  <div class="card-body p-4 d-flex align-items-center gap-4 flex-wrap">
    ...
    <div class="flex-grow-1">
      <!-- Title is clickable → course detail -->
      ...
      <a href="<?= $url('learn/courses/' . ($latest['course_uuid'] ?? '')) ?>"
        ...
        <h5 class="fw-bold mb-2" style="color:var(--text-primary)"><?= $e($latest['title']) ?></h5>
      </a>
    ...
    <div class="col-12 col-md-6 col-lg-4">
      <div class="course-card h-100 d-flex flex-column">
        ...
        <div class="course-body flex-grow-1">
          ...
          <a href="<?= $detailUrl ?>" class="text-decoration-none">
            <div class="course-title" style="color:var(--text-primary)"><?= $e($e2['title']) ?></div>
          </a>
        ...
        <!-- Footer: status badge + action button → player -->
        <div class="course-footer">
          ...
          <a href="<?= $playerUrl ?>" class="<?= $btnClass ?>">
